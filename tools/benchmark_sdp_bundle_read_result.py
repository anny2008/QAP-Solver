...
# Define paths
LOG_FOLDER = "results/sdp_bundle"
OUTPUT_CSV = "results/sdp_bundle_results.csv"
...
with open(OUTPUT_CSV, mode="w", newline="", encoding="utf-8") as csv_file:
    ...
    for filename in os.listdir(LOG_FOLDER):
        if filename.endswith(".log"):  # Only process log files
            ...
            # print(f"Processing {filename}: instance_name={instance_name}, formulation={formulation}, n={n}")
            try:
