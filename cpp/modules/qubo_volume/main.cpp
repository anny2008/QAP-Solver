...
int main(int argc, char* argv[]) {
    ...
    std::cout << "==================================================" << std::endl;
    std::cout << "qubo Volume Algorithm Solver for QAP" << std::endl;
    std::cout << "==================================================" << std::endl;
    ...
    set_up_vol_problem_qubo(vol_problem, qap_data);
    QUBOVolumeHooks hooks(qap_data);
    ...
    if (vol_problem.psol.size() > 0 and formulation != "formulation3" && formulation != "formulation4") {
        auto vsummary = compute_qubo_violation(vol_problem.psol, n);
        std::cout << "\nQUBO violation summary (n=" << n << ")" << std::endl;
        std::cout << "  Row max: " << std::setprecision(6) << vsummary.row_max
                  << ", Col max: " << vsummary.col_max << std::endl;
