...
int main(int argc, char* argv[]) {
    ...
    // if m < n, pad the problem to make m==n
    if (problem.m < problem.n) {
        std::cout << "[CG] Padding problem to make m==n (m=" << problem.m << ", n=" << problem.n << ")\n";
        auto new_F = std::vector<std::vector<double>>(problem.n, std::vector<double>(problem.n, 0.0));
