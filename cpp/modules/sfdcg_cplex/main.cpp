...
int main(int argc, char* argv[]) {
    ...
    if (n > m) {
        ...
        // add dummy facilities to problem.F if needed
    ...
    problem.m = n;
    // decomposition_file = stem of instance filename + "_decomposition.txt"
    cfg.decomposition_file = instance_path.substr(0, instance_path.find_last_of(".")) + "_decomposition.txt";
    cfg.basis_output_file = instance_path.substr(0, instance_path.find_last_of(".")) + "_basis_columns.csv";
    SFDCGSolver solver(cfg);
